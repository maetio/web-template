import { CollectionDataTypes, PublicUserData, SubcollectionDataTypes } from "app/types";
import { FirebaseOptions, initializeApp, getApps } from "firebase/app";
import {
	initializeAuth,
} from "firebase/auth";
import { CollectionReference, DocumentData, FirestoreDataConverter, Query, QueryDocumentSnapshot, collection, collectionGroup, initializeFirestore } from "firebase/firestore";
...
export const teamMessagesSubcollection = (teamID: string) =>
	createCollection<SubcollectionDataTypes["team-messages"]>(`teams/${teamID}/team-messages`);
