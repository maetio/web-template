 ...
 * @return {*} 
 */
const useCreateFirestoreHook = <InputData = never, ReturnDataType = null>(firestoreQuery: FunctionType<InputData, ReturnDataType>): [HookReturnParameters<ReturnDataType>, FunctionType<InputData, ReturnDataType>] => {
	// set return states
	...
	const updateData = useCallback(async (inputData: InputData) => {
		// set states
		setisLoading(true);
		setisSuccess(false);
		setError("");
