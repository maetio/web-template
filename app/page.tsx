...
export default async function Home() {
	...
	return (
		<main>
			...
			<GameCard compDate="Jun 10, 2023" compName="Competition Name" team1Rating={99} team2Rating={99} team1Name="Team 1 Name" team2Name="Team 2 Name" team1rating={99} team2rating={99} />
		</main>
	);
}
