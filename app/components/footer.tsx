	...
	<footer className="bg-white">
		<div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
			<nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
				<div className="pb-6">
					<Link href="https://www.maet.io/" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
						About
					</Link>
				</div>
				<div className="pb-6">
					<Link href="https://blog.maet.io/" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
						Blog
					</Link>
				</div>
			</nav>
			<div className="mt-10 flex justify-center space-x-10">
				<Link href="https://www.linkedin.com/company/maetio" className="text-gray-400 hover:text-gray-500">
