...
export interface CollectionDataTypes {
	...
	competitions: StartTimestamp &
		EndTimestamp &
		Partial<Omit<Competition, "id">>;
...
export interface SubcollectionDataTypes {
	...
	"competition-profiles": Partial<
		Omit<CompetitionProfile, "id"> & EndTimestamp
	>;
	"game-profiles": Partial<
		Omit<GameProfile, "id"> & StartTimestamp & EndTimestamp
	>;
...
> = F extends keyof AllReturnDataTypes[T] & string
	? AllReturnDataTypes[T][F]
	: string;
/**
