...
exports.modules = {
  /***/ 3724: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const _chalk = /*#__PURE__*/ _interop_require_default(
  ...
  /***/ 3851: /***/ (module, exports, __webpack_require__) => {
    ...
    function cookies() {
      ...
      const asyncActionStore =
        _actionasyncstorage.actionAsyncStorage.getStore();
      if (
        asyncActionStore &&
      ...
      constructor(previewProps, req, cookies, mutableCookies) {
        ...
        const cookieValue =
          (_cookies_get = cookies.get(
            _apiutils.COOKIE_NAME_PRERENDER_BYPASS
          )) == null
            ? void 0
            : _cookies_get.value;
    ...
    function autoImplementMethods(handlers) {
      ...
      const methods = _http.HTTP_METHODS.reduce(
        (acc, method) => ({
          ...
          [method]:
            handlers[method] ??
            _responsehandlers.handleMethodNotAllowedResponse,
        }),
        {}
      );
  ...
  /***/ 9267: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    class AppRouteRouteModule extends _routemodule.RouteModule {
      constructor({ userland, pathname, resolvedPagePath, nextConfigOutput }) {
        ...
        // userland module.
        this.methods = (0, _autoimplementmethods.autoImplementMethods)(
          userland
        );
        // Get the non-static methods for this route.
        this.nonStaticMethods = (0, _getnonstaticmethods.getNonStaticMethods)(
          userland
        );
              ...
              () => {
                return _staticgenerationasyncstoragewrapper.StaticGenerationAsyncStorageWrapper.wrap(
                  ...
                  (staticGenerationStore) => {
                    ...
                    const wrappedRequest = (0, _proxyrequest.proxyRequest)(
                      request,
                      {
                        dynamic: this.dynamic,
                      },
                    ...
                    return (0, _tracer.getTracer)().trace(
                      ...
                      async () => {
                        ...
                        context.staticGenerationContext.fetchMetrics =
                          staticGenerationStore.fetchMetrics;
                        await Promise.all(
                          staticGenerationStore.pendingRevalidates || []
                        );
                        (0, _patchfetch.addImplicitTags)(staticGenerationStore);
                        context.staticGenerationContext.fetchTags =
                        ...
                        // here.
                        const requestStore =
                          this.requestAsyncStorage.getStore();
    ...
    function addImplicitTags(staticGenerationStore) {
      ...
      const pathname =
        staticGenerationStore == null
          ? void 0
          : staticGenerationStore.originalPathname;
      if (!pathname) {
        return newTags;
      }
      ...
      globalThis.fetch = async (input, init) => {
        ...
        return await (0, _tracer.getTracer)().trace(
          ...
          async () => {
            ...
            if (
              !staticGenerationStore ||
              ((_ref = init == null ? void 0 : init.next) == null
                ? void 0
                : _ref.internal)
            ) {
                ...
                if (!(staticGenerationStore.isRevalidate && entry.isStale)) {
                  if (entry.isStale) {
                    ...
                    (_staticGenerationStore_incrementalCache =
                      ...
                      ? void 0
                      : _staticGenerationStore_incrementalCache.set(
                          cacheKey,
                          entry.value,
                          revalidate,
                          true,
  ...
  /***/ 1183: /***/ (__unused_webpack_module, exports) => {
    /**
        ...
        const updateResponseCookies = () => {
          ...
          const staticGenerationAsyncStore =
            fetch.__nextGetStaticStore == null
              ? void 0
              : (_fetch___nextGetStaticStore = fetch.__nextGetStaticStore()) ==
                null
              ? void 0
  ...
  /***/ 7970: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
              ...
              const OGImageResponse = // as the auto resolving is not working
                (
                  await Promise.resolve(/* import() */).then(
                    __webpack_require__.bind(__webpack_require__, 4021)
                  )
                ).ImageResponse;
  ...
  /***/ 2917: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    var __webpack_unused_export__;
  ...
  /***/ 9433: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    function getNextPathnameInfo(pathname, options) {
      ...
      if (options.i18nProvider) {
        ...
        info.pathname =
          (_pathLocale_pathname = pathLocale.pathname) != null
            ? _pathLocale_pathname
            : info.pathname;
      }
      return info;
  ...
  /***/ 5084: /***/ (__unused_webpack_module, exports) => {
    /**
  ...
  /***/ 4664: /***/ (module, exports, __webpack_require__) => {
    const serverExports = {
