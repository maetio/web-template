...
*/
  ...
  /***/ 3160: /***/ (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    const _cookie = /*#__PURE__*/ _interop_require_default(
    ...
    function normalizeVercelUrl(
      ...
      if (pageIsDynamic && trustQuery && defaultRouteRegex) {
        ...
        for (const key of Object.keys(_parsedUrl.query)) {
          if (
            (key !== _constants1.NEXT_QUERY_PARAM_PREFIX &&
              key.startsWith(_constants1.NEXT_QUERY_PARAM_PREFIX)) ||
                  ...
                  for (const key of Object.keys(obj)) {
                    ...
                    if (
                      ...
                      const normalizedKey = key.substring(
                        _constants1.NEXT_QUERY_PARAM_PREFIX.length
                      );
